...
class Application(tornado.web.Application):
    def __init__(self):
        handlers = [
            ...
            (r"/instock/api/backtest/grid", backtestHandler.BacktestGridApiHandler),
            (r"/instock/api/backtest/walkforward", backtestHandler.BacktestWalkforwardApiHandler),
            (r"/instock/api/backtest/compare", backtestHandler.BacktestCompareApiHandler),
            (r"/instock/api/backtest/batches/([^/]+)", backtestHandler.BacktestBatchDetailApiHandler),
            (r"/instock/api/backtest/runs", backtestHandler.BacktestRunsApiHandler),
            (r"/instock/api/backtest/runs/([^/]+)/export", backtestHandler.BacktestRunExportApiHandler),

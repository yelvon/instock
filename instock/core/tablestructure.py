...
TABLE_CN_STOCK_DAILY_BAR = {
    ...
    'cn': '标准A股日线行情',
    'columns': {
        'date': {'type': DATE, 'cn': '交易日', 'size': 100},
        'code': {'type': VARCHAR(6, _COLLATE), 'cn': '代码', 'size': 60},
        'adjust_type': {'type': VARCHAR(16, _COLLATE), 'cn': '复权口径', 'size': 40},
        'open': {'type': FLOAT, 'cn': '开盘', 'size': 70},
        'close': {'type': FLOAT, 'cn': '收盘', 'size': 70},
        'high': {'type': FLOAT, 'cn': '最高', 'size': 70},
        'low': {'type': FLOAT, 'cn': '最低', 'size': 70},
        'volume': {'type': FLOAT, 'cn': '成交量(股)', 'size': 90},
        'amount': {'type': FLOAT, 'cn': '成交额', 'size': 100},
        'amplitude': {'type': FLOAT, 'cn': '振幅', 'size': 70},
        'quote_change': {'type': FLOAT, 'cn': '涨跌幅', 'size': 70},
        'ups_downs': {'type': FLOAT, 'cn': '涨跌额', 'size': 70},
        'turnover': {'type': FLOAT, 'cn': '换手率', 'size': 70},
        'quality_status': {'type': VARCHAR(16, _COLLATE), 'cn': '质量状态', 'size': 40},
        'completeness_score': {'type': BIGINT, 'cn': '完整度', 'size': 70},

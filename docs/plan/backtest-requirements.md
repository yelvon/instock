...
API 以 [`../backtest-api-contract.md`](../backtest-api-contract.md) 为准，前端页面设计以 [`backtest-frontend-design.md`](backtest-frontend-design.md) 为准，至少包含：
...
详细验收用例见 [`backtest-acceptance-checklist.md`](backtest-acceptance-checklist.md)。

...
本文档定义 `/backtest` 模块第一期前端设计，覆盖页面结构、图表、表格、交互状态和 API 数据需求。后端契约见 [`../backtest-api-contract.md`](../backtest-api-contract.md)，回测业务需求见 [`backtest-requirements.md`](backtest-requirements.md)。
